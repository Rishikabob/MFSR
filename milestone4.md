...
- **Data Collection**
  ...
  - We want to put numbers to some questions and statements to help us evaluate the success of the product. For each of these questions, we will have a difuculty rating and time it took for the question to be resovled.
  - For the professors, we are looking to see how many students the professors are able to reach in both the control groups and the experimental groups. Professors will have a set problems the professor needs to adress and in each group (control and test), we will monitor how many questions they could resolve and the time it took for each question.
